...
import { Icon, Button, MediaBox, Video, DetailPost, EditPostCard } from "@/components";
...
export default memo(function PostCard(props: PostCardProps) {
    ...
    return (
        <div className={styles.post_card} style={props.style}>
                    ...
                    <div className={styles.post_actions_container}>
                        ...
                        {isOpenPostActions && (
                            <div className={styles.post_actions_list} ref={postActionsRef}>
                                <div className={styles.post_actions_item} onClick={() => {setIsOpenEdit(true); setIsOpenPostActions(false);}}>
            ...
            {isOpenDetail && (
                <DetailPost ref={postDetailRef} className={styles.post_detail_container}></DetailPost>
            )}

            {isOpenEdit && (
                <EditPostCard className={styles.post_edit_container} onClose={() => setIsOpenEdit(false)}></EditPostCard>
            )}
        </div>
    );
});
